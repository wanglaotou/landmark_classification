...
class l2lossWithMulti4(nn.Module):
    def __init__(self):
        super(l2lossWithMulti4, self).__init__()
    ...
    def forward(self, output1, target1):
        ...
        print('output1.shape, target1.shape:', output1.shape, target1.shape)
        # print(target1.shape)
        loss = 0
        
        loss += self.CE(output1, target1)
